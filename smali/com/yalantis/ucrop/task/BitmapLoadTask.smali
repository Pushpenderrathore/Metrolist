...
.method private downloadFile(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    .line 14
    .line 15
    invoke-virtual {v1}, Lcom/yalantis/ucrop/OkHttpClientStore;->getClient()Lrf/u;
    ...
    .line 31
    invoke-virtual {v3, p1}, La3/t;->x(Ljava/lang/String;)V
    :try_end_0
    ...
    .line 35
    .line 36
    invoke-direct {p1, v3}, Lrf/w;-><init>(La3/t;)V
    :try_end_1
    ...
    .line 39
    :try_start_2
    invoke-virtual {v1, p1}, Lrf/u;->b(Lrf/w;)Lvf/p;
    ...
    .line 47
    :try_start_3
    iget-object v3, p1, Lrf/b0;->p:Lrf/d0;

    .line 48
    .line 49
    invoke-virtual {v3}, Lrf/d0;->u0()Lig/k;
    ...
    .line 54
    .line 55
    invoke-direct {p0, v5}, Lcom/yalantis/ucrop/task/BitmapLoadTask;->isContentUri(Landroid/net/Uri;)Z
    ...
    .line 99
    invoke-direct {v0, p2, v5, v6}, Lig/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
    :try_end_4
    ...
    .line 102
    :try_start_5
    invoke-interface {v4, v0}, Lig/k;->h0(Lig/g0;)J
    :try_end_5
    ...
    .line 113
    .line 114
    iget-object p1, v1, Lrf/u;->a:Ld7/b;

    .line 115
    .line 116
    invoke-virtual {p1}, Ld7/b;->l()V
...
.method private processInputUri()V
    ...
    .line 19
    .line 20
    invoke-direct {p0, v0, v2}, Lcom/yalantis/ucrop/task/BitmapLoadTask;->downloadFile(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_0
    ...
    .line 34
    .line 35
    invoke-direct {p0, v0}, Lcom/yalantis/ucrop/task/BitmapLoadTask;->isContentUri(Landroid/net/Uri;)Z
    ...
    .line 44
    .line 45
    invoke-direct {p0, v0, v2}, Lcom/yalantis/ucrop/task/BitmapLoadTask;->copyFile(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_1
    ...
    .line 59
    .line 60
    invoke-direct {p0, v0}, Lcom/yalantis/ucrop/task/BitmapLoadTask;->isFileUri(Landroid/net/Uri;)Z
